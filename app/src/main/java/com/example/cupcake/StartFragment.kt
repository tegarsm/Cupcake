...
/**
 * Ini adalah syntax untuk halaman pertama,
 * dimana user dapat memilih seberapa banyak cake yang akan dipesan
 */
class StartFragment : Fragment() {
    ...
    /**
     * Dimulai dengan jumlah pesanan cake dan navigasi selanjutnya
     */
